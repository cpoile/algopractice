...
var testCases = []struct {
...
}{
	{
		...
		input:       987000321123,
		expected:    "nine hundred eighty-seven billion three hundred twenty-one thousand one hundred twenty-three",
	},
	{
		description: "a big number",
		input:       987654321123,
	...
	{
		description: "nine hundred fifty-nine",
		input:       959,
		expected:    "nine hundred fifty-nine",
	},
	{
	...
	{
		description: "nine hundred forty-five thousand two hundred thirty-four",
		input:       945234,
		expected:    "nine hundred forty-five thousand two hundred thirty-four",
	},
	{
